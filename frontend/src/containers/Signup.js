...
const Signup = ({ signup, isAuthenticated }) => {
    ...
    const cuisine = [
        { label: 'French', year: 1994 },
        { label: 'Chinese', year: 1972 },
        { label: 'Thai', year: 1974 },
        { label: 'Italian', year: 2008 },
        { label: 'Indian', year: 1957 },
        { label: 'Spanish', year: 1993 },
        { label: 'Continental', year: 1993 }
    ]
                        ...
                        <Grid container spacing={2} >
                            ...
                            <Grid xs={6}>
                                <Autocomplete
                                    ...
                                    onChange={e => onChange(e)}
                                    onInputChange={(event, newPrefernce) => {
                                        setPreference(newPrefernce);
                                    }}
                                    renderInput={(params) => (
